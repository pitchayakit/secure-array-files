...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-secure-array-files', __webpack_require__(3));
  Vue.component('detail-secure-array-files', __webpack_require__(6));
  Vue.component('form-secure-array-files', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getFile: function getFile(file, originalName) {
            axios({
    ...
    _c(
      ...
      _vm._l(JSON.parse(_vm.field.value), function(file) {
        return _c(
          ...
          {
            staticClass:
              "bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-2 px-4 rounded inline-flex items-center",
          ...
          [
            ...
            _vm._v(" "),
            _c("span", [_vm._v(_vm._s(file.originalName))])
          ]
        )
      }),
      0
          ...
          "button",
          {
            ...
            on: {
              click: function($event) {
                return _vm.$refs.add_file.click()
              }
            }
          },
          [
            ...
            _c("loader", { class: _vm.hidden, attrs: { width: "30" } })
          ],
          1
        ),
        _vm._v(" "),
